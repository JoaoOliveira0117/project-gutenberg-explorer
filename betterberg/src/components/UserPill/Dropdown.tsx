    ...
    <div className="relative max-h-fit">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <div className="flex items-center cursor-pointer p-3 border border-gray-300 rounded-full bg-white hover:bg-blue-50 transition duration-200 ease-in-out transform hover:scale-105 hover:shadow-md">
          ...
          > 
            ...
            <UserOption icon={<PiSignOutBold className="text-red-600" />} label="Sign Out" onClick={console.log}/>
          </DropdownMenuContent>
        </DropdownMenu>
    </div>
  );
